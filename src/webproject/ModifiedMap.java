	...
	public class ModifiedMap {
	    public static void main(String[] args) {
	        ...
	        try {
	            ...
	            // Calculate the absolute coordinates based on map location
	            Point mapLocation = worldMap.getLocation();
	            int absoluteX = mapLocation.getX() + xOffset;
	            int absoluteY = mapLocation.getY() + yOffset;

	            // Simulate click using JavaScript at the calculated coordinates
	            ...
	            js.executeScript(script, absoluteX, absoluteY);
